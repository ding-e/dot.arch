...
//static char *font = "-adobe-helvetica-bold-r-normal--*-120-*-*-*-*-*-*";
//static char *font = "-misc-fixed-medium-r-semicondensed--13-120-75-75-c-60-iso10646-1";
...
// -------
static unsigned int cols = 172;
static unsigned int rows = 52;
// -------
//static unsigned int cols = 122;
...
static MouseShortcut mshortcuts[] = {
	...
	// =============================
	// st-2-scrollback-mouse
	// { ShiftMask,            Button4, kscrollup,      {.i = 1} },
	// { ShiftMask,            Button5, kscrolldown,    {.i = 1} },
	
	// st-4-scrollback-mouse-increment
...
static Shortcut shortcuts[] = {
	...
	// =============================
	// st-1-scrollback-20200419-72e3f6c.diff
